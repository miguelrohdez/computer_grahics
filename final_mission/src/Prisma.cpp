...
void Prisma::draw() {
    ...
    Plane p[6] = {
        Plane(textures[0], v[0], v[1], v[6], v[7]), // XZ Arriba
        Plane(textures[1], v[2], v[4], v[5], v[3]), // XZ Abajo
        Plane(textures[2], v[0], v[2], v[3], v[1]), // XY Z positiva
        Plane(textures[3], v[6], v[5], v[4], v[7]), // XY Z negativa
        Plane(textures[4], v[1], v[3], v[5], v[6]), // YZ en X positiva
