...
{
	float Angtx;	//Rot. en x Torso
	float Angty;	//Rot. en y
	float Angcx;	//Rot. en x Cabeza
	float Angcy;	//Rot. en y
	float Angbi1x;	//Rot. en X Brazo A Izq
	float Angbi1z;	//Rot. en Z Brazo A Izq
	float Angbi2x;  //Rot. en X Brazo B Izq
	float Angbi2z;  //Rot. en Z Brazo B Izq
	float Angbd1x;
	float Angbd1z;
	float Angbd2x;
	float Angbd2z;
