...
void dibujaEscenario(int render)
{
	...
	glBegin(GL_QUADS);
		glColor3f(0.098f, 0.098f, 0.439f);
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.5f); glVertex3f(850.0f, 0.0f, 25.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(850.0f, 25.0f, 25.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(850.0f, 25.0f, 0.0f);
		glTexCoord2f(0.0f, 0.5f); glVertex3f(850.0f, 0.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.098f, 0.098f, 0.439f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.5f); glVertex3f(900.0f, 0.0f, 25.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(900.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(900.0f, 25.0f, 0.0f);
		glTexCoord2f(0.0f, 0.5f); glVertex3f(900.0f, 25.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glTexCoord2f(1.8f, 0.0f); glVertex3f(975.0f, 0.0f, 25.0f);
		glTexCoord2f(1.8f, 1.0f); glVertex3f(975.0f, 40.0f, 25.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(900.0f, 40.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.118f, 0.565f, 1.000f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(900.0f, 40.0f, 25.0f);
		glTexCoord2f(1.8f, 0.0f); glVertex3f(975.0f, 40.0f, 25.0f);
		glTexCoord2f(1.8f, 1.0f); glVertex3f(975.0f, 40.0f, 0.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(900.0f, 40.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.118f, 0.565f, 1.000f);
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 0.2f); glVertex3f(900.0f, 0.0f, 25.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(900.0f, 40.0f, 25.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(900.0f, 40.0f, 0.0f);
		glTexCoord2f(1.0f, 0.2f); glVertex3f(900.0f, 0.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.118f, 0.565f, 1.000f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.2f); glVertex3f(975.0f, 0.0f, 25.0f);
		glTexCoord2f(0.0f, 0.2f); glVertex3f(975.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(975.0f, 40.0f, 0.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(975.0f, 40.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.7f, 0.2f, 0.1f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(-0.09f, 0.0f); glVertex3f(900.0f, 40.0f, 4.0f);
		glTexCoord2f(2.0f, 0.0f); glVertex3f(975.0f, 40.0f, 4.0f);
		glTexCoord2f(2.0f, 1.0f); glVertex3f(975.0f, 45.0f, 4.0f);
		glTexCoord2f(-0.09f, 1.0f); glVertex3f(900.0f, 45.0f, 4.0f);
	glEnd();

	//OBJETO 38 (3 planos) ///////////////

	glBindTexture(GL_TEXTURE_2D, textura[1].texID);  // TODO: Ver que textura es

	//Plano 1
	glBegin(GL_QUADS);
		glColor3f(0.0f, 0.8f, 0.8f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.83f); glVertex3f(975.0f, 0.0f, 25.0f);
		glTexCoord2f(6.999f, 0.83f); glVertex3f(1370.0f, 0.0f, 25.0f);
		glTexCoord2f(6.999f, 1.0f); glVertex3f(1370.0f, 10.0f, 25.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(975.0f, 10.0f, 25.0f);		 
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.0f, 0.8f, 0.8f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(975.0f, 10.0f, 25.0f);
		glTexCoord2f(7.0f, 0.0f); glVertex3f(1370.0f, 10.0f, 25.0f);
		glTexCoord2f(7.0f, 1.0f); glVertex3f(1370.0f, 10.0f, 0.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(975.0f, 10.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.0f, 0.8f, 0.8f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1370.0f, 0.0f, 25.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1370.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1370.0f, 10.0f, 0.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1370.0f, 10.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.5f, 0.5f, 0.5f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(975.0f, 10.0f, 0.0f);
		glTexCoord2f(8.0f, 0.0f); glVertex3f(1410.0f, 10.0f, 0.0f);
		glTexCoord2f(8.0f, 2.0f); glVertex3f(1410.0f, 82.0f, 0.0f);
		glTexCoord2f(0.0f, 2.0f); glVertex3f(975.0f, 82.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.8f, 0.8f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(990.0f, 50.0f, 19.0f);
		glTexCoord2f(1.5f, 0.0f); glVertex3f(1050.0f, 50.0f, 19.0f);
		glTexCoord2f(1.5f, 1.0f); glVertex3f(1050.0f, 70.0f, 19.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(990.0f, 70.0f, 19.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.8f, 0.8f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1050.0f, 50.0f, 19.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1050.0f, 50.0f, 6.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1050.0f, 70.0f, 6.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1050.0f, 70.0f, 19.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.8f, 0.8f);
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(990.0f, 50.0f, 19.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(990.0f, 70.0f, 19.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(990.0f, 70.0f, 6.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(990.0f, 50.0f, 6.0f);
	glEnd();


	glBindTexture(GL_TEXTURE_2D, textura[12].texID);  // TODO: Textura de forma arbitraria

	//Plano 4
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.8f, 0.8f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(990.0f, 70.0f, 19.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1050.0f, 70.0f, 19.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1050.0f, 70.0f, 6.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(990.0f, 70.0f, 6.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(0.0f, -1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(990.0f, 50.0f, 19.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(990.0f, 50.0f, 6.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1050.0f, 50.0f, 6.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1050.0f, 50.0f, 19.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.6f, 0.1f, 0.0f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1070.0f, 10.0f, 7.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1073.0f, 10.0f, 7.0f);
		glTexCoord2f(1.0f, 2.0f); glVertex3f(1073.0f, 40.0f, 7.0f);
		glTexCoord2f(0.0f, 2.0f); glVertex3f(1070.0f, 40.0f, 7.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.5f, 0.0f, 0.0f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.3f, 0.0f); glVertex3f(1073.0f, 10.0f, 7.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1073.0f, 10.0f, 0.0f);
		glTexCoord2f(0.0f, 5.0f); glVertex3f(1073.0f, 140.0f, 0.0f);
		glTexCoord2f(0.3f, 5.0f); glVertex3f(1073.0f, 140.0f, 7.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.5f, 0.0f, 0.0f);
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.3f, 0.0f); glVertex3f(1070.0f, 10.0f, 7.0f);
		glTexCoord2f(0.3f, 5.0f); glVertex3f(1070.0f, 140.0f, 7.0f);
		glTexCoord2f(0.0f, 5.0f); glVertex3f(1070.0f, 140.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1070.0f, 10.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.6f, 0.3f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1070.0f, 40.0f, 25.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1073.0f, 40.0f, 25.0f);
		glTexCoord2f(1.0f, 4.0f); glVertex3f(1073.0f, 140.0f, 25.0f);
		glTexCoord2f(0.0f, 4.0f); glVertex3f(1070.0f, 140.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.6f, 0.4f, 0.1f);
		glNormal3f(0.0f, -1.0f, 0.0f);
		glTexCoord2f(0.1f, 0.0f); glVertex3f(1070.0f, 40.0f, 25.0f);
		glTexCoord2f(0.1f, 1.0f); glVertex3f(1070.0f, 40.0f, 7.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1073.0f, 40.0f, 7.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1073.0f, 40.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1073.0f, 40.0f, 25.0f);
		glTexCoord2f(0.3f, 0.0f); glVertex3f(1073.0f, 40.0f, 7.0f);
		glTexCoord2f(0.3f, 4.0f); glVertex3f(1073.0f, 140.0f, 7.0f);
		glTexCoord2f(1.0f, 4.0f); glVertex3f(1073.0f, 140.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.6f, 0.4f, 0.1f);
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1070.0f, 40.0f, 25.0f);
		glTexCoord2f(1.0f, 4.0f); glVertex3f(1070.0f, 140.0f, 25.0f);
		glTexCoord2f(0.3f, 4.0f); glVertex3f(1070.0f, 140.0f, 7.0f);
		glTexCoord2f(0.3f, 0.0f); glVertex3f(1070.0f, 40.0f, 7.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1090.0f, 50.0f, 19.0f);
		glTexCoord2f(1.5f, 0.0f); glVertex3f(1150.0f, 50.0f, 19.0f);
		glTexCoord2f(1.5f, 1.0f); glVertex3f(1150.0f, 70.0f, 19.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1090.0f, 70.0f, 19.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.25f, 0.29f, 0.44f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1150.0f, 50.0f, 19.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1150.0f, 50.0f, 6.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1150.0f, 70.0f, 6.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1150.0f, 70.0f, 19.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1090.0f, 50.0f, 19.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1090.0f, 70.0f, 19.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1090.0f, 70.0f, 6.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1090.0f, 50.0f, 6.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.25f, 0.29f, 0.44f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1090.0f, 70.0f, 19.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1150.0f, 70.0f, 19.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1150.0f, 70.0f, 6.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1090.0f, 70.0f, 6.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(0.0f, -1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1090.0f, 50.0f, 19.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1090.0f, 50.0f, 6.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1150.0f, 50.0f, 6.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1150.0f, 50.0f, 19.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.6f, 0.1f, 0.0f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1190.0f, 10.0f, 7.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1193.0f, 10.0f, 7.0f);
		glTexCoord2f(1.0f, 2.0f); glVertex3f(1193.0f, 40.0f, 7.0f);
		glTexCoord2f(0.0f, 2.0f); glVertex3f(1190.0f, 40.0f, 7.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.5f, 0.0f, 0.0f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.3f, 0.0f); glVertex3f(1193.0f, 10.0f, 7.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1193.0f, 10.0f, 0.0f);
		glTexCoord2f(0.0f, 5.0f); glVertex3f(1193.0f, 140.0f, 0.0f);
		glTexCoord2f(0.3f, 5.0f); glVertex3f(1193.0f, 140.0f, 7.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.5f, 0.0f, 0.0f);
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.3f, 0.0f); glVertex3f(1190.0f, 10.0f, 7.0f);
		glTexCoord2f(0.3f, 5.0f); glVertex3f(1190.0f, 140.0f, 7.0f);
		glTexCoord2f(0.0f, 5.0f); glVertex3f(1190.0f, 140.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1190.0f, 10.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.6f, 0.3f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1190.0f, 40.0f, 25.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1193.0f, 40.0f, 25.0f);
		glTexCoord2f(1.0f, 4.0f); glVertex3f(1193.0f, 140.0f, 25.0f);
		glTexCoord2f(0.0f, 4.0f); glVertex3f(1190.0f, 140.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.6f, 0.4f, 0.1f);
		glNormal3f(0.0f, -1.0f, 0.0f);
		glTexCoord2f(0.1f, 0.0f); glVertex3f(1190.0f, 40.0f, 25.0f);
		glTexCoord2f(0.1f, 1.0f); glVertex3f(1190.0f, 40.0f, 7.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1193.0f, 40.0f, 7.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1193.0f, 40.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1193.0f, 40.0f, 25.0f);
		glTexCoord2f(0.3f, 0.0f); glVertex3f(1193.0f, 40.0f, 7.0f);
		glTexCoord2f(0.3f, 4.0f); glVertex3f(1193.0f, 140.0f, 7.0f);
		glTexCoord2f(1.0f, 4.0f); glVertex3f(1193.0f, 140.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.6f, 0.4f, 0.1f);
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1190.0f, 40.0f, 25.0f);
		glTexCoord2f(1.0f, 4.0f); glVertex3f(1190.0f, 140.0f, 25.0f);
		glTexCoord2f(0.3f, 4.0f); glVertex3f(1190.0f, 140.0f, 7.0f);
		glTexCoord2f(0.3f, 0.0f); glVertex3f(1190.0f, 40.0f, 7.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.0f, 0.0f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1275.0f, 22.0f, 21.0f);
		glTexCoord2f(1.0f, 0.8f); glVertex3f(1325.0f, 22.0f, 21.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1325.0f, 30.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1275.0f, 30.0f, 21.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.0f, 0.0f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1325.0f, 22.0f, 21.0f);
		glTexCoord2f(1.0f, 0.8f); glVertex3f(1325.0f, 22.0f, 4.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1325.0f, 30.0f, 4.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1325.0f, 30.0f, 21.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.4f, 0.0f, 0.0f);
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.8f); glVertex3f(1275.0f, 22.0f, 21.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1275.0f, 30.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1275.0f, 30.0f, 4.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1275.0f, 22.0f, 4.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.0f, 0.0f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1275.0f, 30.0f, 21.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1325.0f, 30.0f, 21.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1325.0f, 30.0f, 4.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1275.0f, 30.0f, 4.0f);
	glEnd();

	glBindTexture(GL_TEXTURE_2D, textura[12].texID);  // TODO: textura arbitraria

	//Plano 5
	glBegin(GL_QUADS);
		glColor3f(0.8f, 0.0f, 0.0f);
		glNormal3f(0.0f, -1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1275.0f, 22.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1275.0f, 22.0f, 4.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1325.0f, 22.0f, 4.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1325.0f, 22.0f, 21.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1345.0f, 34.0f, 21.0f);
		glTexCoord2f(1.0f, 0.8f); glVertex3f(1390.0f, 34.0f, 21.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1390.0f, 42.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1345.0f, 42.0f, 21.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.67f, 0.99f, 0.45f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1390.0f, 34.0f, 21.0f);
		glTexCoord2f(1.0f, 0.8f); glVertex3f(1390.0f, 34.0f, 4.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1390.0f, 42.0f, 4.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1390.0f, 42.0f, 21.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.8f); glVertex3f(1345.0f, 34.0f, 21.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1345.0f, 42.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1345.0f, 42.0f, 4.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1345.0f, 34.0f, 4.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.67f, 0.99f, 0.45f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1345.0f, 42.0f, 21.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1390.0f, 42.0f, 21.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1390.0f, 42.0f, 4.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1345.0f, 42.0f, 4.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.67f, 0.99f, 0.45f);
		glNormal3f(0.0f, -1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1345.0f, 34.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1345.0f, 34.0f, 4.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1390.0f, 34.0f, 4.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1390.0f, 34.0f, 21.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.5f); glVertex3f(1405.0f, 0.0f, 25.0f);
		glTexCoord2f(4.0f, 0.5f); glVertex3f(1650.0f, 0.0f, 25.0f);
		glTexCoord2f(4.0f, 1.0f); glVertex3f(1650.0f, 10.0f, 25.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1405.0f, 10.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.45f, 0.99f, 0.67f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1405.0f, 10.0f, 25.0f);
		glTexCoord2f(4.0f, 0.0f); glVertex3f(1650.0f, 10.0f, 25.0f);
		glTexCoord2f(4.0f, 1.0f); glVertex3f(1650.0f, 10.0f, 0.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1405.0f, 10.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.3f); glVertex3f(1405.0f, 0.0f, 25.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1405.0f, 10.0f, 25.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1405.0f, 10.0f, 0.0f);
		glTexCoord2f(0.0f, 0.3f); glVertex3f(1405.0f, 0.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.7f, 0.2f, 0.1f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(-0.09f, 0.0f); glVertex3f(1405.0f, 10.0f, 4.0f);
		glTexCoord2f(10.0f, 0.0f); glVertex3f(1650.0f, 10.0f, 4.0f);
		glTexCoord2f(10.0f, 1.0f); glVertex3f(1650.0f, 15.0f, 4.0f);
		glTexCoord2f(-0.09f, 1.0f); glVertex3f(1405.0f, 15.0f, 4.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1410.0f, 44.0f, 21.0f);
		glTexCoord2f(4.0f, 0.8f); glVertex3f(1600.0f, 44.0f, 21.0f);
		glTexCoord2f(4.0f, 1.0f); glVertex3f(1600.0f, 52.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1410.0f, 52.0f, 21.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(1.0f, 1.0f, 0.14f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1600.0f, 44.0f, 21.0f);
		glTexCoord2f(1.0f, 0.8f); glVertex3f(1600.0f, 44.0f, 4.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1600.0f, 52.0f, 4.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1600.0f, 52.0f, 21.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 0.8f); glVertex3f(1410.0f, 44.0f, 4.0f);
		glTexCoord2f(1.0f, 0.8f); glVertex3f(1410.0f, 44.0f, 21.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1410.0f, 52.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1410.0f, 52.0f, 4.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(1.0f, 1.0f, 0.14f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1410.0f, 52.0f, 21.0f);
		glTexCoord2f(4.0f, 0.0f); glVertex3f(1600.0f, 52.0f, 21.0f);
		glTexCoord2f(4.0f, 1.0f); glVertex3f(1600.0f, 52.0f, 4.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1410.0f, 52.0f, 4.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(1.0f, 1.0f, 0.14f);
		glNormal3f(0.0f, -1.0f, 0.0f);
		glTexCoord2f(1.0f, 0.0f); glVertex3f(1600.0f, 44.0f, 21.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1410.0f, 44.0f, 21.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1410.0f, 44.0f, 4.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1600.0f, 44.0f, 4.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1650.0f, 0.0f, 25.0f);
		glTexCoord2f(1.5f, 0.0f); glVertex3f(1705.0f, 0.0f, 25.0f);
		glTexCoord2f(1.5f, 1.0f); glVertex3f(1705.0f, 25.0f, 25.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1650.0f, 25.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glNormal3f(-1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.5f); glVertex3f(1650.0f, 0.0f, 25.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1650.0f, 25.0f, 25.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1650.0f, 25.0f, 0.0f);
		glTexCoord2f(0.0f, 0.5f); glVertex3f(1650.0f, 0.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(1.0f, 0.99f, 0.45f);
		glNormal3f(1.0f, 0.0f, 0.0f);
		glTexCoord2f(1.0f, 0.5f); glVertex3f(1705.0f, 0.0f, 25.0f);
		glTexCoord2f(1.0f, 1.0f); glVertex3f(1705.0f, 0.0f, 0.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1705.0f, 25.0f, 0.0f);
		glTexCoord2f(0.0f, 0.5f); glVertex3f(1705.0f, 25.0f, 25.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(1.0f, 0.99f, 0.45f);
		glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(0.0f, 0.0f); glVertex3f(1650.0f, 25.0f, 25.0f);
		glTexCoord2f(1.5f, 0.0f); glVertex3f(1705.0f, 25.0f, 25.0f);
		glTexCoord2f(1.5f, 1.0f); glVertex3f(1705.0f, 25.0f, 0.0f);
		glTexCoord2f(0.0f, 1.0f); glVertex3f(1650.0f, 25.0f, 0.0f);
	glEnd();
	...
	glBegin(GL_QUADS);
		glColor3f(0.7f, 0.2f, 0.1f);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glTexCoord2f(-0.09f, 0.0f); glVertex3f(1650.0f, 25.0f, 4.0f);
		glTexCoord2f(2.0f, 0.0f); glVertex3f(1705.0f, 25.0f, 4.0f);
		glTexCoord2f(2.0f, 1.0f); glVertex3f(1705.0f, 30.0f, 4.0f);
		glTexCoord2f(-0.09f, 1.0f); glVertex3f(1650.0f, 30.0f, 4.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1705.0f, 0.0f, 25.0f);
	glTexCoord2f(1.8f, 0.0f); glVertex3f(1815.0f, 0.0f, 25.0f);
	glTexCoord2f(1.8f, 1.0f); glVertex3f(1815.0f, 40.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1705.0f, 40.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.71f, 1.0f, 0.83f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1705.0f, 40.0f, 25.0f);
	glTexCoord2f(1.8f, 0.0f); glVertex3f(1815.0f, 40.0f, 25.0f);
	glTexCoord2f(1.8f, 1.0f); glVertex3f(1815.0f, 40.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1705.0f, 40.0f, 0.0f);
	glEnd();
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(1705.0f, 0.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1705.0f, 40.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1705.0f, 40.0f, 0.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(1705.0f, 0.0f, 0.0f);
	glEnd();
	...
	glColor3f(0.71f, 1.0f, 0.83f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(1815.0f, 0.0f, 25.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(1815.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1815.0f, 40.0f, 0.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1815.0f, 40.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.7f, 0.2f, 0.1f);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(-0.09f, 0.0f); glVertex3f(1705.0f, 40.0f, 4.0f);
	glTexCoord2f(4.0f, 0.0f); glVertex3f(1815.0f, 40.0f, 4.0f);
	glTexCoord2f(4.0f, 1.0f); glVertex3f(1815.0f, 45.0f, 4.0f);
	glTexCoord2f(-0.09f, 1.0f); glVertex3f(1705.0f, 45.0f, 4.0f);
	glEnd();

	//OBJETO 55 (1 plano) ///////////////  CAMBIO Z
	...
	glColor3f(0.5f, 0.5f, 0.5f);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1600.0f, 10.0f, 0.0f);
	glTexCoord2f(32.0f, 0.0f); glVertex3f(2020.0f, 10.0f, 0.0f);
	glTexCoord2f(32.0f, 4.0f); glVertex3f(2020.0f, 82.0f, 0.0f);
	glTexCoord2f(0.0f, 4.0f); glVertex3f(1600.0f, 82.0f, 0.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.5f); glVertex3f(1815.0f, 0.0f, 25.0f);
	glTexCoord2f(4.0f, 0.5f); glVertex3f(2020.0f, 0.0f, 25.0f);
	glTexCoord2f(4.0f, 1.0f); glVertex3f(2020.0f, 10.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1815.0f, 10.0f, 25.0f);
	glEnd();
	...
	glColor3f(1.0f, 0.89f, 0.46f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1815.0f, 10.0f, 25.0f);
	glTexCoord2f(4.0f, 0.0f); glVertex3f(2020.0f, 10.0f, 25.0f);
	glTexCoord2f(4.0f, 1.0f); glVertex3f(2020.0f, 10.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1815.0f, 10.0f, 0.0f);
	glEnd();
	...
	glColor3f(0.7f, 0.2f, 0.1f);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(-0.09f, 0.0f); glVertex3f(1815.0f, 10.0f, 4.0f);
	glTexCoord2f(10.0f, 0.0f); glVertex3f(2020.0f, 10.0f, 4.0f);
	glTexCoord2f(10.0f, 1.0f); glVertex3f(2020.0f, 15.0f, 4.0f);
	glTexCoord2f(-0.09f, 1.0f); glVertex3f(1815.0f, 15.0f, 4.0f);
	glEnd();
	...
	glColor3f(0.5f, 0.0f, 0.0f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.3f, 0.0f); glVertex3f(1873.0f, 10.0f, 7.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1873.0f, 10.0f, 0.0f);
	glTexCoord2f(0.0f, 5.0f); glVertex3f(1873.0f, 140.0f, 0.0f);
	glTexCoord2f(0.3f, 5.0f); glVertex3f(1873.0f, 140.0f, 7.0f);
	glEnd();
	...
	glColor3f(0.5f, 0.0f, 0.0f);
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.3f, 0.0f); glVertex3f(1870.0f, 10.0f, 7.0f);
	glTexCoord2f(0.3f, 5.0f); glVertex3f(1870.0f, 140.0f, 7.0f);
	glTexCoord2f(0.0f, 5.0f); glVertex3f(1870.0f, 140.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1870.0f, 10.0f, 0.0f);
	glEnd();
	...
	glColor3f(0.8f, 0.6f, 0.3f);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1870.0f, 40.0f, 25.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(1873.0f, 40.0f, 25.0f);
	glTexCoord2f(1.0f, 4.0f); glVertex3f(1873.0f, 140.0f, 25.0f);
	glTexCoord2f(0.0f, 4.0f); glVertex3f(1870.0f, 140.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.7f, 0.5f, 0.2f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 4.0f); glVertex3f(1873.0f, 40.0f, 25.0f);
	glTexCoord2f(0.3f, 4.0f); glVertex3f(1873.0f, 40.0f, 7.0f);
	glTexCoord2f(0.3f, 0.0f); glVertex3f(1873.0f, 140.0f, 7.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(1873.0f, 140.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.6f, 0.4f, 0.1f);
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(1870.0f, 40.0f, 25.0f);
	glTexCoord2f(0.3f, 0.0f); glVertex3f(1870.0f, 140.0f, 25.0f);
	glTexCoord2f(0.3f, 4.0f); glVertex3f(1870.0f, 140.0f, 7.0f);
	glTexCoord2f(1.0f, 4.0f); glVertex3f(1870.0f, 40.0f, 7.0f);
	glEnd();
	...
	glTexCoord2f(1.0f, 0.0f); glVertex3f(1870.0f, 40.0f, 25.0f);
	glTexCoord2f(1.0f, 4.0f); glVertex3f(1870.0f, 40.0f, 7.0f);
	glTexCoord2f(0.0f, 4.0f); glVertex3f(1873.0f, 40.0f, 7.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1873.0f, 40.0f, 25.0f);
	glEnd();
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.3f, 0.0f); glVertex3f(1897.0f, 10.0f, 7.0f);
	glTexCoord2f(0.3f, 5.0f); glVertex3f(1897.0f, 140.0f, 7.0f);
	glTexCoord2f(0.0f, 5.0f); glVertex3f(1897.0f, 140.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1897.0f, 10.0f, 0.0f);
	glEnd();
	...
	glColor3f(0.20f, 0.35f, 0.55f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.3f, 0.0f); glVertex3f(1900.0f, 10.0f, 7.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1900.0f, 10.0f, 0.0f);
	glTexCoord2f(0.0f, 5.0f); glVertex3f(1900.0f, 140.0f, 0.0f);
	glTexCoord2f(0.3f, 5.0f); glVertex3f(1900.0f, 140.0f, 7.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1897.0f, 40.0f, 25.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(1900.0f, 40.0f, 25.0f);
	glTexCoord2f(1.0f, 4.0f); glVertex3f(1900.0f, 140.0f, 25.0f);
	glTexCoord2f(0.0f, 4.0f); glVertex3f(1897.0f, 140.0f, 25.0f);
	glEnd();
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(1897.0f, 40.0f, 25.0f);
	glTexCoord2f(0.3f, 0.0f); glVertex3f(1897.0f, 140.0f, 25.0f);
	glTexCoord2f(0.3f, 4.0f); glVertex3f(1897.0f, 140.0f, 7.0f);
	glTexCoord2f(1.0f, 4.0f); glVertex3f(1897.0f, 40.0f, 7.0f);
	glEnd();
	...
	glColor3f(0.57f, 0.96f, 0.88f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 4.0f); glVertex3f(1900.0f, 40.0f, 25.0f);
	glTexCoord2f(0.3f, 4.0f); glVertex3f(1900.0f, 40.0f, 7.0f);
	glTexCoord2f(0.3f, 0.0f); glVertex3f(1900.0f, 140.0f, 7.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(1900.0f, 140.0f, 25.0f);
	glEnd();
	...
	glTexCoord2f(1.0f, 0.0f); glVertex3f(1897.0f, 40.0f, 25.0f);
	glTexCoord2f(1.0f, 4.0f); glVertex3f(1897.0f, 40.0f, 7.0f);
	glTexCoord2f(0.0f, 4.0f); glVertex3f(1900.0f, 40.0f, 7.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(1900.0f, 40.0f, 25.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.6f, 2.0f); glVertex3f(1930.0f, 30.0f, 25.0f);
	glTexCoord2f(0.15f, 2.0f); glVertex3f(1945.0f, 30.0f, 25.0f);
	glTexCoord2f(0.15f, 0.2f); glVertex3f(1945.0f, 140.0f, 25.0f);
	glTexCoord2f(0.6f, 0.2f); glVertex3f(1930.0f, 140.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.95f, 0.72f, 1.00f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1945.0f, 30.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1945.0f, 30.0f, 7.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(1945.0f, 140.0f, 7.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(1945.0f, 140.0f, 25.0f);
	glEnd();
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1930.0f, 30.0f, 25.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(1930.0f, 140.0f, 25.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(1930.0f, 140.0f, 7.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1930.0f, 30.0f, 7.0f);
	glEnd();
	...
	glColor3f(0.95f, 0.72f, 1.00f);
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.6f, 0.0f); glVertex3f(1930.0f, 30.0f, 25.0f);
	glTexCoord2f(0.6f, 1.0f); glVertex3f(1930.0f, 30.0f, 7.0f);
	glTexCoord2f(0.15f, 1.0f); glVertex3f(1945.0f, 30.0f, 7.0f);
	glTexCoord2f(0.15f, 0.0f); glVertex3f(1945.0f, 30.0f, 25.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.15f, 0.0f); glVertex3f(1970.0f, 10.0f, 25.0f);
	glTexCoord2f(0.6f, 0.0f); glVertex3f(1985.0f, 10.0f, 25.0f);
	glTexCoord2f(0.6f, 1.0f); glVertex3f(1985.0f, 65.0f, 25.0f);
	glTexCoord2f(0.15f, 1.0f); glVertex3f(1970.0f, 65.0f, 25.0f);
	glEnd();
	...
	glColor3f(1.0f, 0.12f, 0.11f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(1985.0f, 10.0f, 25.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(1985.0f, 10.0f, 7.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1985.0f, 65.0f, 7.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1985.0f, 65.0f, 25.0f);
	glEnd();
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(1970.0f, 10.0f, 25.0f);
	glTexCoord2f(0.f, 1.0f); glVertex3f(1970.0f, 65.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1970.0f, 65.0f, 7.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(1970.0f, 10.0f, 7.0f);
	glEnd();
	...
	glColor3f(1.0f, 0.12f, 0.11f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.15f, 0.0f); glVertex3f(1970.0f, 65.0f, 25.0f);
	glTexCoord2f(0.6f, 0.0f); glVertex3f(1985.0f, 65.0f, 25.0f);
	glTexCoord2f(0.6f, 1.0f); glVertex3f(1985.0f, 65.0f, 7.0f);
	glTexCoord2f(0.15f, 1.0f); glVertex3f(1970.0f, 65.0f, 7.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.81f); glVertex3f(1945.0f, 30.0f, 25.0f);
	glTexCoord2f(1.0f, 0.81f); glVertex3f(1970.0f, 30.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1970.0f, 33.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1945.0f, 33.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.22f, 0.22f, 0.72f);
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.375f, 0.8f); glVertex3f(1945.0f, 30.0f, 25.0f);
	glTexCoord2f(0.375f, 1.0f); glVertex3f(1945.0f, 30.0f, 7.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1970.0f, 30.0f, 7.0f);
	glTexCoord2f(0.0f, 0.8f); glVertex3f(1970.0f, 30.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.22f, 0.22f, 0.72f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.8f); glVertex3f(1945.0f, 33.0f, 25.0f);
	glTexCoord2f(0.375f, 0.8f); glVertex3f(1970.0f, 33.0f, 25.0f);
	glTexCoord2f(0.375f, 1.0f); glVertex3f(1970.0f, 33.0f, 7.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1945.0f, 33.0f, 7.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.81f); glVertex3f(1945.0f, 46.0f, 25.0f);
	glTexCoord2f(1.0f, 0.81f); glVertex3f(1970.0f, 46.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1970.0f, 49.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1945.0f, 49.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.55f, 0.82f, 0.89f);
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.375f, 0.8f); glVertex3f(1945.0f, 46.0f, 25.0f);
	glTexCoord2f(0.375f, 1.0f); glVertex3f(1945.0f, 46.0f, 7.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1970.0f, 46.0f, 7.0f);
	glTexCoord2f(0.0f, 0.8f); glVertex3f(1970.0f, 46.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.55f, 0.82f, 0.89f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.8f); glVertex3f(1945.0f, 49.0f, 25.0f);
	glTexCoord2f(0.375f, 0.8f); glVertex3f(1970.0f, 49.0f, 25.0f);
	glTexCoord2f(0.375f, 1.0f); glVertex3f(1970.0f, 49.0f, 7.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1945.0f, 49.0f, 7.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.81f); glVertex3f(1945.0f, 62.0f, 25.0f);
	glTexCoord2f(1.0f, 0.81f); glVertex3f(1970.0f, 62.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(1970.0f, 65.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1945.0f, 65.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.55f, 0.62f, 0.26f);
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.375f, 0.8f); glVertex3f(1945.0f, 62.0f, 25.0f);
	glTexCoord2f(0.375f, 1.0f); glVertex3f(1945.0f, 62.0f, 7.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1970.0f, 62.0f, 7.0f);
	glTexCoord2f(0.0f, 0.8f); glVertex3f(1970.0f, 62.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.55f, 0.62f, 0.26f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.8f); glVertex3f(1945.0f, 65.0f, 25.0f);
	glTexCoord2f(0.375f, 0.8f); glVertex3f(1970.0f, 65.0f, 25.0f);
	glTexCoord2f(0.375f, 1.0f); glVertex3f(1970.0f, 65.0f, 7.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(1945.0f, 65.0f, 7.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.4f); glVertex3f(2020.0f, 0.0f, 25.0f);
	glTexCoord2f(1.0f, 0.4f); glVertex3f(2060.0f, 0.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(2060.0f, 25.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(2020.0f, 25.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.36f, 0.65f, 0.14f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(2020.0f, 25.0f, 25.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(2060.0f, 25.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(2060.0f, 25.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(2020.0f, 25.0f, 0.0f);
	glEnd();
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(2020.0f, 0.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(2020.0f, 25.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(2020.0f, 25.0f, 0.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(2020.0f, 0.0f, 0.0f);
	glEnd();
	...
	glColor3f(0.36f, 0.65f, 0.14f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(2060.0f, 0.0f, 25.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(2060.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(2060.0f, 25.0f, 0.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(2060.0f, 25.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.7f, 0.2f, 0.1f);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(-0.09f, 0.0f); glVertex3f(2020.0f, 25.0f, 4.0f);
	glTexCoord2f(2.0f, 0.0f); glVertex3f(2060.0f, 25.0f, 4.0f);
	glTexCoord2f(2.0f, 1.0f); glVertex3f(2060.0f, 30.0f, 4.0f);
	glTexCoord2f(-0.09f, 1.0f); glVertex3f(2020.0f, 30.0f, 4.0f);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(2060.0f, 0.0f, 25.0f);
	glTexCoord2f(3.0f, 0.0f); glVertex3f(2270.0f, 0.0f, 25.0f);
	glTexCoord2f(3.0f, 1.0f); glVertex3f(2270.0f, 40.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(2060.0f, 40.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.14f, 0.42f, 0.22f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(2060.0f, 40.0f, 25.0f);
	glTexCoord2f(3.0f, 0.0f); glVertex3f(2270.0f, 40.0f, 25.0f);
	glTexCoord2f(3.0f, 1.0f); glVertex3f(2270.0f, 40.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(2060.0f, 40.0f, 0.0f);
	glEnd();
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(2060.0f, 0.0f, 25.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(2060.0f, 40.0f, 25.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(2060.0f, 40.0f, 0.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(2060.0f, 0.0f, 0.0f);
	glEnd();
	...
	glColor3f(0.14f, 0.42f, 0.22f);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 0.2f); glVertex3f(2270.0f, 0.0f, 25.0f);
	glTexCoord2f(0.0f, 0.2f); glVertex3f(2270.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(2270.0f, 40.0f, 0.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(2270.0f, 40.0f, 25.0f);
	glEnd();
	...
	glColor3f(0.7f, 0.2f, 0.1f);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(-0.09f, 0.0f); glVertex3f(2060.0f, 40.0f, 4.0f);
	glTexCoord2f(4.0f, 0.0f); glVertex3f(2130.0f, 40.0f, 4.0f);
	glTexCoord2f(4.0f, 1.0f); glVertex3f(2130.0f, 45.0f, 4.0f);
	glTexCoord2f(-0.09f, 1.0f); glVertex3f(2060.0f, 45.0f, 4.0f);
	glEnd();
	...
	int			nCmdShow)			// Muestra el estado de la ventana
{
	...
	if (!CreaVentanaOGL("Laboratorio de Computación Gráfica", 1366, 768, 16))
	{
